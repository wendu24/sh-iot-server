...
public class UdpDeviceRecentDataServiceImpl extends ServiceImpl<UdpDeviceRecentDataMapper, UdpDeviceRecentDataDO> implements UdpDeviceRecentDataService {
    ...
    public Page<UdpDeviceRecentDataDO> list(RecentDataQueryVO recentDataQueryVO){
        ...
        queryWrapper.ge(Objects.nonNull(recentDataQueryVO.getCollectStartTime()),UdpDeviceRecentDataDO::getCollectTime,recentDataQueryVO.getCollectStartTime());
        queryWrapper.le(Objects.nonNull(recentDataQueryVO.getCollectEndTime()),UdpDeviceRecentDataDO::getCollectTime,recentDataQueryVO.getCollectEndTime());
