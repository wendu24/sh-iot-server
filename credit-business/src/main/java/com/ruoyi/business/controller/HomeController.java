...
public class HomeController {
    ...
    public AjaxResult waterTemperatureAndHour(@RequestBody HomeQueryVO homeQueryVO){
        return AjaxResult.success(homeService.waterTemperatureAndHour(homeQueryVO));
    }
